...
* [Week 12: MOS Cap Fabrication and Characterisation](#Week-12-MOS-Cap-Fabrication-and-Characterisation)
	- [MOS Cap Fabrication](#MOS-Cap-Fabrication)
...
LDR are usually available in 3mm and 5mm dimensions.
...
### Calculated Capacitance 
 - ε(SiO2) = 4 
 - t(ox) = 300nm
 - **C(ox) = 29.525pF** (for 500um pitch width)
 - **C(ox) = 18.896pF** (for 400um pitch width)
 - **C(ox) = 10.629pF** (for 300um pitch width)
